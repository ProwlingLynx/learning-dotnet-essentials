...
using System.Text.RegularExpressions; // not default.
...
// regex is capital words with no whitespace
Regex CapWords = new Regex(@"[A-Z]\w+"); // using @ infront of a string tells the compiler that it is a literal string without escapes for backslash \
