...
// Console.WriteLine($"{isEqual}"); // should be false.
...
// int result = String.Compare(str2, "This is a string"); // usually used for sorting.
// Console.WriteLine($"{result}");

// TODO: Replacing content
// remember that strings are immutable despite how it looks.
